---
title: "CIP2021_Abbreviated CIP title"
author: "Jay Kim"
date: "12/7/2021"
...
```{r}
# library(readr)
# CIPCode2020_V0 <- CIPCode2020Origin %>% 
#     mutate(CIP_CODE= as.numeric(gsub("[[:punct:]]", "", CIPCode))) %>% 
#     mutate(CIP_COCE = paste0( 0, CIP_CODE, sep=""))
# write.csv(CIPCode2020_V0, "CIPCode2020_V0.csv", row.names = F)
library(readr)
...
view(CIPCode2020V1)
write.csv(CIPCode2020V1, "CIPCode2020V1.csv",row.names = F)
```
